...
public class Validator {
	 ...
	 * @param digitAccountedFor a boolean array, specifying whether that index can be used again
	 ...
	 *
	 * @param  secret    the opponent's secret number as a int array of digits
	 * @param  guess     the player's guess as an int array of digits
	 * @param  numDigits the number of digits in the number (should be the same as guess.length and secret.length)
