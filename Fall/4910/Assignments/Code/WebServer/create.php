        			...
        			<div class="info-box">
            			...
            			<div class="textbox">
              				...
              				<select id="userType">
                  				...
                  				<option value="ADMINISTRAVTIVE">Admin</option>
              				</select>

              				<br/>
              				<div>ID#:</div>
              				<input class="test7" type="text" id="idnumber" required>
              				<br/>
              				<div>Name:</div>
              				<input class="test5" type="text" id="name" required>
              				<br/>
              				<div>Email:</div>
              		`		<input class="test5" type="text" id="email" required>
              				<br/>
              				<div>Username:</div>
              				<input class="test1" type="text" id="username" required>
              				<br/>
              				<div>Password:</div>
              				<input class="test3" type="text" id="password" required>
						</div>
