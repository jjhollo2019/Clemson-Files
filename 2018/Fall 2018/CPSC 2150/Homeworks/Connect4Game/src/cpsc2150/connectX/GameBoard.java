...
public class GameBoard {
     ...
     * @pre user must verify input 0 >= c < 7
     ...
     * @pre board must be initialized, user must verify input
     ...
     * @pre board must be initialized, user must verify correct input
    ...
    public static boolean checkDiagWin(int r, int c, char p){
        //check if any of these conditions exist
        if (board[2][0] == p && board[3][1] == p && board[4][2] == p && board[5][3] == p || board[1][0] == p &&
                board[2][1] == p && board[3][2] == p && board[4][3] == p || board[0][0] == p &&
                board[1][1] == p && board[2][2] == p && board[3][3] == p || board[0][1] == p &&
                board[1][2] == p && board[2][3] == p && board[3][4] == p || board[1][1] == p &&
                board[2][2] == p && board[3][3] == p && board[4][4] == p || board[2][1] == p &&
                board[3][2] == p && board[4][3] == p && board[5][4] == p ||
                board[0][2] == p && board[1][3] == p && board[2][4] == p && board[3][5] == p ||
                board[1][2] == p && board[2][3] == p && board[3][4] == p && board[4][5] == p ||
                board[2][2] == p && board[3][3] == p && board[4][4] == p && board[5][5] == p ||
                board[0][3] == p && board[1][4] == p && board[2][5] == p && board[3][6] == p ||
                board[1][3] == p && board[2][4] == p && board[3][5] == p && board[4][6] == p ||
                board[2][3] == p && board[3][4] == p && board[4][5] == p && board[5][6] == p){
     ...
     * @pre constructor must be called before using toString
