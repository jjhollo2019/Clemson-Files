    ...
    private static void play(){
        ...
        while (gameOn) {
            ...
            if (column < 0 || column >= 7) {
                //print error message
                System.out.println("Error! Invalid input Column " + column + " does not exist");
                //ask for input
                System.out.println("Player X, what column would you like to place your marker in?");
            ...
            column = Integer.parseInt(keyboard.nextLine());//grab input
            if (column < 0 && column >= 7) {//verify input is in range
                //print error message
                System.out.println("Error! Invalid input Column " + column + " does not exist");
                //ask for new input
                System.out.println("Player O, what column would you like to place your marker in?");
                column = Integer.parseInt(keyboard.nextLine());//grab new value
            }
