...
public class MortgageView extends JFrame implements ActionListener, IMortgageView {


    private MortgageController cont;
    ...
    public void setController(MortgageController c)
    {
        cont = c;
    }
