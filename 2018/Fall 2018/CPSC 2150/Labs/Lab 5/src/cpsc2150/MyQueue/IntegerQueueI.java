...
public interface IntegerQueueI
{
    ...
    {
        Integer r = 0;//initialize return int
        Integer y;//declare iteration int
    ...
    {
        Integer r = 0;//initialize return value
        Integer y;//declare iteration int
        for (int i = 0; i < size(); i++) {//loop through the structure
    ...
    {
        Integer m = 0;//initialize return value
        Integer y;//declare iteration int
        if (pos == 1)
        {
            m = pop();
    ...
    {
        Integer r = 0;//initialize the return value
        Integer y;//declare iteration int
        for (int i = 0; i < size(); i++) {//loop through the queue
